...
#
"""
The module that defines the DscpGroup class.
"""
...
class DscpGroup:
    ...
    def __eq__(self, dscp_group):
        ...
        return self._dscp_group_dict == dscp_group._dscp_group_dict
    ...
    def commands(self):
        """
        Generate a list of (path, command) tuples required to create this NPF
        dscp-group
        """
        dscp_values = ""
    ...
    def delete_cmd(self):
        """
        Generate the (path, command) tuple required to delete this NPF
        dscp-group
        """
